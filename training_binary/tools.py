...
#-----------------------------------------------------------------------------#
path_to_model = 'output_books_full/model_binary_iter_{}.npz'
path_to_dictionary = 'output_books_full/books.vocab'
path_to_word2vec = '/data2/akeller/skip_thoughts_neon/data/books_txt_processed_full/GoogleNews-vectors-negative300.bin'
#-----------------------------------------------------------------------------#
