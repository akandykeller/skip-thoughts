...
ex = Experiment('skip-thought-orig')
...
def config():
    ...
    save_path = 'output_books_full/model_full_bsz_64_M2400_iter_{}.npz'
    reload_path =  'output_books_full/model_full_bsz_64_M2400_iter_170000.npz'
    reload_ = True
    batch_size = 64
...
def main(data_path, dict_path, save_path, batch_size, reload_, reload_path):
    ...
    train.trainer(train_sent, batch_size=batch_size,  reload_=reload_, dictionary=dict_path, saveto=save_path, reload_path=reload_path, saveFreq=10)  
